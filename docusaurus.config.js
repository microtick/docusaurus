  ...
  themeConfig: {
    navbar: {
      ...
      items: [
        ...
        {
          href: 'https://gitlab.com/microtick/docusaurus',
    ...
    footer: {
      ...
      copyright: `Copyright © ${new Date().getFullYear()} Microtick. Built with Docusaurus.`,
    },
  },
  presets: [
    [
      '@docusaurus/preset-classic',
      {
        docs: {
          ...
          editUrl:
            'https://gitlab.com/microtick/docusaurus/edit/master/website/',
        },
        theme: {
